...
const xml=`<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n${urls.map((path,i)=>`  <url><loc>${base}${path}</loc><lastmod>${changedPaths.has(path)?changedDate:defaultDate}</lastmod><priority>${i===0?"1.0":path==="/best-builds/"||path.startsWith("/builds/")||path.startsWith("/classes/")?"0.9":"0.7"}</priority></url>`).join("\n")}\n</urlset>\n`;
