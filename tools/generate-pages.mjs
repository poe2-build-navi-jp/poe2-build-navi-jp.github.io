...
<body>
  ...
  <main id="main">
    ...
    <div class="detail-main">
      ...
      <section id="now" class="now-panel" aria-labelledby="now-title"><div class="now-stage"><small>あなたは現在ここ</small><strong id="now-stage">Lv1〜10</strong></div><div class="now-actions"><p id="now-source-label" class="section-kicker">${verified ? "掲載資料から整理した優先行動" : "確認済み範囲から整理した優先行動"}</p><h2 id="now-title">今やること</h2><div class="priority-list"><div class="priority-item"><b>最優先</b><span data-now-action></span></div><div class="priority-item"><b>次</b><span data-now-action></span></div><div class="priority-item"><b>その次</b><span data-now-action></span></div></div><p id="now-action-guidance" class="disclaimer" hidden></p><p id="now-next" class="disclaimer"></p></div></section>
