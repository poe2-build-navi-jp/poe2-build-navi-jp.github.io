...
function detailPage(build) {
  ...
  const breadcrumb = JSON.stringify({
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "ビルド", item: `${baseUrl}/builds/` },
...
<body>
  ...
  <nav class="breadcrumbs" aria-label="パンくず"><ol><li><a href="/">ホーム</a></li><li><a href="/builds/">ビルド</a></li><li id="breadcrumb-name">${escapeHtml(build.name)}</li></ol></nav>
  <main id="main">
    ...
    <div class="detail-main">
      ...
      <section class="progress-card" aria-labelledby="progress-title"><div class="progress-head"><div><p class="section-kicker">MY PROGRESS</p><h2 id="progress-title">ビルド完成度</h2></div><strong id="progress-percent">0%</strong></div><div class="progress-track" aria-hidden="true"><span id="progress-bar"></span></div><div id="progress-checks" class="progress-checks"></div><p id="progress-next" class="next-advice"></p><p class="disclaimer">チェック状態はこの端末に保存されます。</p></section>
...
console.log(`Generated ${builds.length} build detail pages.`);
